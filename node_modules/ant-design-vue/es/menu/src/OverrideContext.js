...
export var OverrideContextKey = Symbol('OverrideContextKey');
export var useInjectOverride = function useInjectOverride() {
  return inject(OverrideContextKey, undefined);
};
export var useProvideOverride = function useProvideOverride(props) {
  var _a, _b, _c;
  var _ref = useInjectOverride() || {},
