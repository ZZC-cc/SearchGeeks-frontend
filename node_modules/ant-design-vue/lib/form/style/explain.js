...
var genFormValidateMotionStyle = function genFormValidateMotionStyle(token) {
  ...
  }, (0, _defineProperty2.default)(_helpItemCls, "&".concat(helpItemCls, "-appear, &").concat(helpItemCls, "-enter"), (0, _defineProperty2.default)({
    transform: "translateY(-5px)",
    opacity: 0
  }, "&-active", {
    transform: 'translateY(0)',
    opacity: 1
  })), (0, _defineProperty2.default)(_helpItemCls, "&".concat(helpItemCls, "-leave-active"), {
    transform: "translateY(-5px)"
  }), _helpItemCls)));
};
