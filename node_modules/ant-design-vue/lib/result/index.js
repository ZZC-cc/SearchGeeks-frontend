...
var Result = (0, _vue.defineComponent)({
  ...
  setup: function setup(props, _ref2) {
    ...
    var className = (0, _vue.computed)(function () {
      return (0, _classNames2.default)(prefixCls.value, hashId.value, "".concat(prefixCls.value, "-").concat(props.status), (0, _defineProperty2.default)({}, "".concat(prefixCls.value, "-rtl"), direction.value === 'rtl'));
    });
    return function () {
