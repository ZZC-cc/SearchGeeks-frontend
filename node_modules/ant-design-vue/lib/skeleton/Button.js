...
var SkeletonButton = (0, _vue.defineComponent)({
  ...
  setup: function setup(props) {
    ...
    var cls = (0, _vue.computed)(function () {
      var _classNames;
      return (0, _classNames2.default)(prefixCls.value, "".concat(prefixCls.value, "-element"), (_classNames = {}, (0, _defineProperty2.default)(_classNames, "".concat(prefixCls.value, "-active"), props.active), (0, _defineProperty2.default)(_classNames, "".concat(prefixCls.value, "-block"), props.block), _classNames), hashId.value);
    });
    return function () {
