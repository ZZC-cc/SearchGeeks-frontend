...
var Select = (0, _vue.defineComponent)({
  ...
  setup: function setup(props, _ref) {
    ...
    return function () {
      ...
      (0, _objectDestructuringEmpty2.default)(configProvider);
      // ===================== Empty =====================
      var mergedNotFound;
      ...
      var rcSelectRtlDropdownClassName = (0, _classNames3.default)(popupClassName || dropdownClassName, (0, _defineProperty2.default)({}, "".concat(prefixCls.value, "-dropdown-").concat(direction.value), direction.value === 'rtl'), hashId.value);
