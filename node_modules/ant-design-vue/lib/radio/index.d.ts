...
declare const _default: {
    new (...args: any[]): {
        ...
        }>> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "onClick" | "onFocus" | "onBlur" | "onChange" | "disabled" | "checked" | "autofocus" | "isGroup" | "onUpdate:checked" | "onUpdate:value">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
