...
var genCardActionsStyle = function genCardActionsStyle(token) {
  ...
  return (0, _extends5.default)((0, _extends5.default)({
    ...
    '& > li': {
      ...
      }, (0, _defineProperty2.default)(_span, "a:not(".concat(componentCls, "-btn), > ").concat(iconCls), {
        display: 'inline-block',
        width: '100%',
        color: token.colorTextDescription,
      ...
      }), (0, _defineProperty2.default)(_span, "> ".concat(iconCls), {
...
var genCardTypeInnerStyle = function genCardTypeInnerStyle(token) {
  ...
  return _ref = {}, (0, _defineProperty2.default)(_ref, "".concat(componentCls, "-head"), {
    padding: "0 ".concat(cardPaddingBase, "px"),
    background: colorFillAlter,
    '&-title': {
      fontSize: token.fontSize
    }
  }), (0, _defineProperty2.default)(_ref, "".concat(componentCls, "-body"), {
...
var genCardStyle = function genCardStyle(token) {
  ...
  var componentCls = token.componentCls,
    ...
    cardPaddingBase = token.cardPaddingBase;
  return _ref3 = {}, (0, _defineProperty2.default)(_ref3, componentCls, (0, _extends5.default)((0, _extends5.default)({}, (0, _style.resetComponent)(token)), (_extends4 = {
    position: 'relative',
    background: token.colorBgContainer,
    borderRadius: token.borderRadiusLG
  }, (0, _defineProperty2.default)(_extends4, "&:not(".concat(componentCls, "-bordered)"), {
    boxShadow: boxShadow
  }), (0, _defineProperty2.default)(_extends4, "".concat(componentCls, "-head"), genCardHeadStyle(token)), (0, _defineProperty2.default)(_extends4, "".concat(componentCls, "-extra"), {
    // https://stackoverflow.com/a/22429853/3040605
    marginInlineStart: 'auto',
    color: '',
    fontWeight: 'normal',
    fontSize: token.fontSize
  }), (0, _defineProperty2.default)(_extends4, "".concat(componentCls, "-body"), (0, _extends5.default)({
    padding: cardPaddingBase,
    borderRadius: " 0 0 ".concat(token.borderRadiusLG, "px ").concat(token.borderRadiusLG, "px")
  }, (0, _style.clearFix)())), (0, _defineProperty2.default)(_extends4, "".concat(componentCls, "-grid"), genCardGridStyle(token)), (0, _defineProperty2.default)(_extends4, "".concat(componentCls, "-cover"), {
    '> *': {
      display: 'block',
      width: '100%'
    },
  ...
  }), (0, _defineProperty2.default)(_extends4, "".concat(componentCls, "-actions"), genCardActionsStyle(token)), (0, _defineProperty2.default)(_extends4, "".concat(componentCls, "-meta"), genCardMetaStyle(token)), _extends4))), (0, _defineProperty2.default)(_ref3, "".concat(componentCls, "-bordered"), (0, _defineProperty2.default)({
    border: "".concat(token.lineWidth, "px ").concat(token.lineType, " ").concat(colorBorderSecondary)
  }, "".concat(componentCls, "-cover"), {
    marginTop: -1,
    marginInlineStart: -1,
    marginInlineEnd: -1
  })), (0, _defineProperty2.default)(_ref3, "".concat(componentCls, "-hoverable"), {
    cursor: 'pointer',
  ...
  }), (0, _defineProperty2.default)(_ref3, "".concat(componentCls, "-contain-grid"), (_$concat2 = {}, (0, _defineProperty2.default)(_$concat2, "".concat(componentCls, "-body"), {
    display: 'flex',
    flexWrap: 'wrap'
  }), (0, _defineProperty2.default)(_$concat2, "&:not(".concat(componentCls, "-loading) ").concat(componentCls, "-body"), {
    marginBlockStart: -token.lineWidth,
    marginInlineStart: -token.lineWidth,
    padding: 0
  }), _$concat2)), (0, _defineProperty2.default)(_ref3, "".concat(componentCls, "-contain-tabs"), (0, _defineProperty2.default)({}, "> ".concat(componentCls, "-head"), (0, _defineProperty2.default)({}, "".concat(componentCls, "-head-title, ").concat(componentCls, "-extra"), {
    paddingTop: cardHeadPadding
  }))), (0, _defineProperty2.default)(_ref3, "".concat(componentCls, "-type-inner"), genCardTypeInnerStyle(token)), (0, _defineProperty2.default)(_ref3, "".concat(componentCls, "-loading"), genCardLoadingStyle(token)), (0, _defineProperty2.default)(_ref3, "".concat(componentCls, "-rtl"), {
    direction: 'rtl'
  }), _ref3;
};
// ============================== Size ==============================
var genCardSizeStyle = function genCardSizeStyle(token) {
  ...
  return _ref4 = {}, (0, _defineProperty2.default)(_ref4, "".concat(componentCls, "-small"), (_$concat7 = {}, (0, _defineProperty2.default)(_$concat7, "> ".concat(componentCls, "-head"), (0, _defineProperty2.default)({
    minHeight: cardHeadHeightSM,
    padding: "0 ".concat(cardPaddingSM, "px"),
    fontSize: token.fontSize
  }, "> ".concat(componentCls, "-head-wrapper"), (0, _defineProperty2.default)({}, "> ".concat(componentCls, "-extra"), {
    fontSize: token.fontSize
  }))), (0, _defineProperty2.default)(_$concat7, "> ".concat(componentCls, "-body"), {
    padding: cardPaddingSM
  }), _$concat7)), (0, _defineProperty2.default)(_ref4, "".concat(componentCls, "-small").concat(componentCls, "-contain-tabs"), (0, _defineProperty2.default)({}, "> ".concat(componentCls, "-head"), (0, _defineProperty2.default)({}, "".concat(componentCls, "-head-title, ").concat(componentCls, "-extra"), {
    minHeight: cardHeadHeightSM,
    paddingTop: 0,
    display: 'flex',
    alignItems: 'center'
