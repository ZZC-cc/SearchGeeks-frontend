...
function usePickerInput(_ref) {
  var open = _ref.open,
    ...
    _onBlur = _ref.onBlur;
  var typing = (0, _vue.shallowRef)(false);
  var focused = (0, _vue.shallowRef)(false);
  /**
   * We will prevent blur to handle open event when user click outside,
   * since this will repeat trigger `onOpenChange` event.
   */
  var preventBlurRef = (0, _vue.shallowRef)(false);
  var valueChangedRef = (0, _vue.shallowRef)(false);
  var preventDefaultRef = (0, _vue.shallowRef)(false);
  ...
  var globalMousedownEvent = (0, _vue.shallowRef)();
