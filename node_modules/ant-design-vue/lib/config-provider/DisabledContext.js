...
var useInjectDisabled = function useInjectDisabled() {
  return (0, _vue.inject)(DisabledContextKey, (0, _vue.ref)(undefined));
};
exports.useInjectDisabled = useInjectDisabled;
var useProviderDisabled = function useProviderDisabled(disabled) {
  var parentDisabled = useInjectDisabled();
  (0, _vue.provide)(DisabledContextKey, (0, _vue.computed)(function () {
    var _a;
