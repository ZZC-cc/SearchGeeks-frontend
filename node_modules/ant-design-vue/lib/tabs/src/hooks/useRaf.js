...
function useRaf(callback) {
  var rafRef = (0, _vue.shallowRef)();
  var removedRef = (0, _vue.shallowRef)(false);
  function trigger() {
...
function useRafState(defaultState) {
  var batchRef = (0, _vue.shallowRef)([]);
  var state = (0, _vue.shallowRef)(typeof defaultState === 'function' ? defaultState() : defaultState);
