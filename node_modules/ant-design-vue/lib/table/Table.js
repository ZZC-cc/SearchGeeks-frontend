...
var InteralTable = (0, _vue.defineComponent)({
  ...
  slots: ['emptyText', 'expandIcon', 'title', 'footer', 'summary', 'expandedRowRender', 'bodyCell', 'headerCell', 'customFilterIcon', 'customFilterDropdown', 'expandColumnTitle'],
  setup: function setup(props, _ref) {
    ...
    var columnTitleProps = (0, _vue.computed)(function () {
      var mergedFilters = {};
      var filtersValue = filters.value;
      Object.keys(filtersValue).forEach(function (filterKey) {
    ...
    (0, _vue.watchEffect)(function () {
      ...
      changeEventInfo.pagination = props.pagination === false ? {} : (0, _usePagination3.getPaginationParam)(mergedPagination.value, props.pagination);
    ...
    return function () {
      ...
      var wrapperClassNames = (0, _classNames4.default)("".concat(prefixCls.value, "-wrapper"), (0, _defineProperty2.default)({}, "".concat(prefixCls.value, "-wrapper-rtl"), direction.value === 'rtl'), attrs.class, hashId.value);
