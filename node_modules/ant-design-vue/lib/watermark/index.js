...
var BaseSize = 2;
var FontGap = 3;
var watermarkProps = function watermarkProps() {
  return {
    zIndex: Number,
    rotate: Number,
    width: Number,
...
var Watermark = (0, _vue.defineComponent)({
  name: 'AWatermark',
  inheritAttrs: false,
  ...
  setup: function setup(props, _ref) {
    ...
    var watermarkRef = (0, _vue.shallowRef)();
    var stopObservation = (0, _vue.shallowRef)(false);
    var gapX = (0, _vue.computed)(function () {
      var _a, _b;
      return (_b = (_a = props.gap) === null || _a === void 0 ? void 0 : _a[0]) !== null && _b !== void 0 ? _b : 100;
    });
    var gapY = (0, _vue.computed)(function () {
      var _a, _b;
      return (_b = (_a = props.gap) === null || _a === void 0 ? void 0 : _a[1]) !== null && _b !== void 0 ? _b : 100;
    });
    var gapXCenter = (0, _vue.computed)(function () {
      return gapX.value / 2;
    });
    var gapYCenter = (0, _vue.computed)(function () {
      return gapY.value / 2;
    });
    var offsetLeft = (0, _vue.computed)(function () {
      var _a, _b;
    ...
    var markStyle = (0, _vue.computed)(function () {
      var _a;
      var markStyle = {
