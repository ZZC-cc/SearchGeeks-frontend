...
var _default2 = (0, _vue.defineComponent)({
  ...
  setup: function setup(props, _ref) {
    ...
    var mobile = (0, _vue.shallowRef)(false);
    (0, _vue.onMounted)(function () {
      mobile.value = (0, _isMobile.default)();
    });
    var legacyTreeSelectContext = (0, _LegacyContext.default)();
    // ============================== Refs ==============================
    var containerRef = (0, _vue.shallowRef)(null);
    var selectorDomRef = (0, _createRef.default)();
    var triggerRef = (0, _vue.shallowRef)(null);
    var selectorRef = (0, _vue.shallowRef)(null);
    var listRef = (0, _vue.shallowRef)(null);
    ...
    var innerOpen = (0, _vue.shallowRef)(initOpen);
    var mergedOpen = (0, _vue.shallowRef)(initOpen);
    ...
    var focusRef = (0, _vue.shallowRef)(false);
    ...
    // ============================= Dropdown ==============================
    var containerWidth = (0, _vue.shallowRef)(null);
