...
var _default = (0, _vue.defineComponent)({
  ...
  setup: function setup(props, _ref) {
    var attrs = _ref.attrs,
      slots = _ref.slots;
    var lastOutSideActiveElementRef = (0, _vue.shallowRef)();
    var wrapperRef = (0, _vue.shallowRef)();
    var contentRef = (0, _vue.shallowRef)();
    var animatedVisible = (0, _vue.shallowRef)(props.visible);
    var ariaIdRef = (0, _vue.shallowRef)("vcDialogTitle".concat((0, _util.getUUID)()));
    // ========================= Events =========================
    ...
    // >>> Content
    var contentClickRef = (0, _vue.shallowRef)(false);
    var contentTimeoutRef = (0, _vue.shallowRef)();
