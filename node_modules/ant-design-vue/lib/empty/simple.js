...
var Simple = (0, _vue.defineComponent)({
  compatConfig: {
    MODE: 3
  },
  setup: function setup() {
    ...
    var color = (0, _vue.computed)(function () {
      var _token$value = token.value,
        colorFill = _token$value.colorFill,
        colorFillTertiary = _token$value.colorFillTertiary,
        colorFillQuaternary = _token$value.colorFillQuaternary,
        colorBgContainer = _token$value.colorBgContainer;
      return {
